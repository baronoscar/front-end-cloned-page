    ...
    var p = function () {
        ...
        return a(t, [{
            ...
            key: "renderPaths", value: function (t) {
                var e, i = t.j, a = t.realIndex, s = t.pathFrom, r = t.pathTo, n = t.stroke, l = t.strokeWidth,
                    h = t.strokeLinecap, c = t.fill, d = t.animationDelay, g = t.initialSpeed, u = t.dataChangeSpeed,
                    p = t.className, b = t.shouldClipToGrid, m = void 0 === b || b, v = t.bindEventsOnPaths,
                ...
                if (z.attr("index", a), m && z.attr({"clip-path": "url(#gridRectMask".concat(A.globals.cuid, ")")}), "none" !== A.config.states.normal.filter.type) S.getDefaultFilter(z, a); else if (A.config.chart.dropShadow.enabled && k && (!A.config.chart.dropShadow.enabledOnSeries || A.config.chart.dropShadow.enabledOnSeries && -1 !== A.config.chart.dropShadow.enabledOnSeries.indexOf(a))) {
                ...
                return !L || A.globals.resized || A.globals.dataChanged ? !A.globals.resized && A.globals.dataChanged || C.showDelayedElements() : C.animatePathsGradually(o(o({}, E), {}, {speed: g})), A.globals.dataChanged && P && T && C.animatePathsGradually(o(o({}, E), {}, {speed: u})), z
            }
        }, {
        ...
        return a(t, [{
            key: "addPointAnnotation", value: function (t, e, i) {
                ...
                if (r = a.globals.gridHeight - h - parseFloat(t.label.style.fontSize) - t.marker.size, o = a.globals.gridHeight - h, a.config.yaxis[t.yAxisIndex] && a.config.yaxis[t.yAxisIndex].reversed && (r = h + parseFloat(t.label.style.fontSize) + t.marker.size, o = h), p.isNumber(s)) {
                    ...
                    var v = t.label.text ? t.label.text : "", w = this.annoCtx.graphics.drawText({
                        x: s + t.label.offsetX,
                        y: r + t.label.offsetY,
                        text: v,
                        textAnchor: t.label.textAnchor,
                    ...
                    if (t.image.path) {
                        var A = t.image.width ? t.image.width : 20, S = t.image.height ? t.image.height : 20;
    ...
    var A = {
        ...
        return a(t, [{
            ...
            key: "handlePatternFill", value: function (t, e, i, a) {
                var s = this.w.config, r = this.opts, o = new b(this.ctx),
            ...
            key: "handleGradientFill", value: function (t, e, i) {
                var a, s = this.w.config, r = this.opts, o = new b(this.ctx), n = new p, l = s.fill.gradient.type,
                    h = t,
        ...
        return a(t, [{
            key: "draw", value: function (t, e, i) {
                var a = this.w, s = new b(this.ctx), r = i.realIndex, o = i.pointsPos, n = i.zRatio, l = i.elParent,
            ...
            key: "drawPoint", value: function (t, e, i, a, s, r, o) {
                var n, l = this.w, h = s, c = new f(this.ctx), d = new x(this.ctx), g = new L(this.ctx),
                    u = new P(this.ctx), p = new b(this.ctx), m = u.getMarkerConfig("apexcharts-marker", h),
                    v = g.fillPath({
                        seriesNumber: s,
                        dataPointIndex: r,
        ...
        return a(t, [{
            key: "dataLabelsCorrection", value: function (t, e, i, a, s, r, o) {
                var n = this.w, l = !1, h = new b(this.ctx).getTextRects(i, o), c = h.width, d = h.height;
            ...
            key: "drawDataLabel", value: function (t, e, i) {
                var a = this, s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 2, r = this.w,
                    o = new b(this.ctx), n = r.config.dataLabels, l = 0, h = 0, c = i, d = null;
            ...
            key: "plotDataLabelsText", value: function (t) {
                var e = this.w, i = new b(this.ctx), a = t.x, s = t.y, r = t.i, o = t.j, n = t.text, l = t.textAnchor,
        ...
        return a(t, [{
            key: "handleBarDataLabels", value: function (t) {
                var e = t.x, i = t.y, a = t.y1, s = t.y2, r = t.i, o = t.j, n = t.realIndex, l = t.series,
                    ...
                    p = this.w, f = new b(this.barCtx.ctx),
            ...
            key: "drawCalculatedDataLabels", value: function (t) {
                var e = t.x, i = t.y, a = t.val, s = t.i, r = t.j, n = t.textRects, l = t.barHeight, h = t.barWidth,
                ...
                var u = new M(this.barCtx.ctx), p = new b(this.barCtx.ctx), f = c.formatter, x = null,
                    m = d.globals.collapsedSeriesIndices.indexOf(s) > -1;
                if (c.enabled && !m) {
                    x = p.group({class: "apexcharts-data-labels", transform: g});
                    var v = "";
                    void 0 !== a && (v = f(a, {seriesIndex: s, dataPointIndex: r, w: d}));
        ...
        return a(t, [{
            ...
            key: "getPathFillColor", value: function (t, e, i, a) {
                var s = this.w, r = new L(this.barCtx.ctx), o = null, n = this.barCtx.barOptions.distributed ? i : e;
            ...
            key: "barBackground", value: function (t) {
                var e = t.j, i = t.i, a = t.x1, s = t.x2, r = t.y1, o = t.y2, n = t.elSeries, l = this.w,
                    h = new b(this.barCtx.ctx), c = new z(this.barCtx.ctx).getActiveConfigSeriesIndex();
            ...
            key: "getColumnPaths", value: function (t) {
                var e = t.barWidth, i = t.barXPosition, a = t.yRatio, s = t.y1, r = t.y2, o = t.strokeWidth,
                    n = t.series, l = t.realIndex, h = t.i, c = t.j, d = t.w, g = new b(this.barCtx.ctx);
                (o = Array.isArray(o) ? o[l] : o) || (o = 0);
                var u = {barWidth: e, strokeWidth: o, yRatio: a, barXPosition: i, y1: s, y2: r},
                    p = this.getRoundedBars(d, u, n, h, c), f = i, x = i + e, m = g.move(f, s), v = g.move(f, s),
                    y = g.line(x - o, s);
            ...
            key: "getBarpaths", value: function (t) {
                var e = t.barYPosition, i = t.barHeight, a = t.x1, s = t.x2, r = t.strokeWidth, o = t.series,
                    n = t.realIndex, l = t.i, h = t.j, c = t.w, d = new b(this.barCtx.ctx);
            ...
            key: "getRoundedBars", value: function (t, e, i, a, s) {
                var r = new b(this.barCtx.ctx), o = 0, n = t.config.plotOptions.bar.borderRadius, l = Array.isArray(n);
            ...
            key: "drawGoalLine", value: function (t) {
                var e = t.barXPosition, i = t.barYPosition, a = t.goalX, s = t.goalY, r = t.barWidth, o = t.barHeight,
                    n = new b(this.barCtx.ctx), l = n.group({className: "apexcharts-bar-goals-groups"}), h = null;
        ...
        return a(t, [{
            key: "draw", value: function (t, e) {
                ...
                for (var n = 0, l = 0; n < t.length; n++, l++) {
                    var h, c, d, g, u = void 0, f = void 0, x = [], m = [], v = i.globals.comboCharts ? e[n] : n,
                        w = a.group({
                    ...
                    for (var C = a.group({
                        ...
                        var T = this.barHelpers.getStrokeWidth(n, P, v), M = null,
            ...
            key: "renderSeries", value: function (t) {
                var e = t.realIndex, i = t.pathFill, a = t.lineFill, s = t.j, r = t.i, o = t.pathFrom, n = t.pathTo,
                    ...
                    f = t.barHeight, m = t.barWidth, v = t.barYPosition, y = t.elDataLabelsWrap, w = t.elGoalsMarkers,
                    k = t.visibleSeries, A = t.type, S = this.w, C = new b(this.ctx);
        ...
        return a(t, [{
            ...
            key: "formatDate", value: function (t, e) {
                var i = this.w.globals.locale, a = this.w.config.xaxis.labels.datetimeUTC,
                    ...
                    o = ["\x02"].concat(g(i.days)), n = ["\x03"].concat(g(i.shortDays));
                ...
                var u = a ? t.getUTCHours() : t.getHours(), p = u > 12 ? u - 12 : 0 === u ? 12 : u;
        ...
        return a(s, [{
            key: "draw", value: function (t, e) {
                ...
                for (var s = a.group({class: "apexcharts-rangebar-series apexcharts-plot-series"}), r = 0; r < t.length; r++) {
                    var n, l, h, c = void 0, d = void 0, g = void 0, u = i.globals.comboCharts ? e[r] : r, f = a.group({
                        class: "apexcharts-series",
        ...
        return a(t, [{
            ...
            key: "isFormatXY", value: function () {
                var t = this.w.config.series.slice(), e = new z(this.ctx);
            ...
            key: "handleRangeDataFormat", value: function (t, e, i) {
                ...
                if ("array" === t) {
                    ...
                    for (var h = function (t) {
                        var o = p.randomId(), n = e[i].data[t].x,
        ...
        return a(t, [{
            key: "getLabel", value: function (t, e, i, a) {
                var s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [],
                    ...
                    c = o.config.xaxis.labels.formatter, d = !1, g = new W(this.ctx), u = n;
            ...
            key: "drawYAxisTicks", value: function (t, e, i, a, s, r, o) {
                var n = this.w, l = new b(this.ctx), h = n.globals.translateY;
                if (a.show && e > 0) {
        ...
        return a(t, [{
            ...
            key: "exportToCSV", value: function (t) {
                var e = this, i = t.series, a = t.columnDelimiter, s = t.lineDelimiter, r = void 0 === s ? "\n" : s,
                    o = this.w, n = [], l = [], h = "data:text/csv;charset=utf-8,\ufeff", c = new O(this.ctx),
                    d = new B(this.ctx), g = function (t) {
                        ...
                        if (o.globals.axisCharts) {
                            if ("category" === o.config.xaxis.type || o.config.xaxis.convertedCatToNumeric) if (o.globals.isBarHorizontal) {
                                var s = o.globals.yLabelFormatters[0], r = new z(e.ctx).getActiveConfigSeriesIndex();
        ...
        return a(t, [{
            ...
            key: "_drawGridBandRect", value: function (t) {
                var e = t.c, i = t.x1, a = t.y1, s = t.x2, r = t.y2, o = t.type, n = this.w, l = new b(this.ctx),
        ...
        return a(t, [{
            key: "niceScale", value: function (t, e) {
                ...
                var h = i + 1;
                h < 2 ? h = 2 : h > 2 && (h -= 2);
                var c = o / h, d = Math.floor(p.log10(c)), g = Math.pow(10, d), u = Math.round(c / g);
                u < 1 && (u = 1);
                var f = u * g, x = f * Math.floor(t / f), b = f * Math.ceil(e / f), m = x;
                if (s && o > 2) {
                    for (; l.push(m), !((m += f) > b);) ;
            ...
            key: "setYScaleForIndex", value: function (t, e, i) {
                ...
                var o = Math.abs(i - e);
                if (r.logarithmic && o <= 5 && (a.invalidLogScale = !0), r.logarithmic && o > 5) a.allSeriesCollapsed = !1, a.yAxisScale[t] = this.logarithmicScale(i); else if (i !== -Number.MAX_VALUE && p.isNumber(i)) if (a.allSeriesCollapsed = !1, void 0 === r.min && void 0 === r.max || r.forceNiceScale) {
        ...
        return a(t, [{
            key: "drawXCrosshairs", value: function () {
                var t = this.w, e = new b(this.ctx), i = new x(this.ctx), a = t.config.xaxis.crosshairs.fill.gradient,
                    ...
                    u = s.top, f = s.blur, m = s.color, v = s.opacity, y = t.config.xaxis.crosshairs.fill.color;
        ...
        return a(t, [{
            key: "getxAxisLabelsCoords", value: function () {
                ...
                if (e.config.xaxis.convertedCatToNumeric && 0 === i.length && (i = e.globals.categoryLabels), e.globals.timescaleLabels.length > 0) {
                    ...
                    var s = e.globals.xLabelFormatter, r = p.getLargestStringFromArr(i),
            ...
            key: "getyAxisLabelsCoords", value: function () {
                ...
                return e.config.yaxis.map((function (r, o) {
                    ...
                    if (!s.isYAxisHidden(o) && r.labels.show && void 0 !== r.labels.minWidth && (l = r.labels.minWidth), !s.isYAxisHidden(o) && r.labels.show && n.result.length) {
                        ...
                        var x = new b(t.dCtx.ctx), m = "rotate(".concat(r.labels.rotate, " 0 0)"),
                            v = x.getTextRects(g, r.labels.style.fontSize, r.labels.style.fontFamily, m, !1), y = v;
        ...
        return a(s, [{
            ...
            key: "selectionDrawn", value: function (t) {
                ...
                if (a.config.yaxis.forEach((function (t, e) {
                    ...
                    var u = p.clone(a.globals.initialConfig.yaxis), f = p.clone(a.globals.initialConfig.xaxis);
            ...
            key: "panScrolled", value: function (t, e) {
                var i = this.w, a = this.xyRatios, s = p.clone(i.globals.initialConfig.yaxis), r = a.xRatio,
        ...
        return a(t, [{
            key: "getNearestValues", value: function (t) {
                var e = t.hoverArea, i = t.elGrid, a = t.clientX, s = t.clientY, r = this.w, o = r.globals.gridWidth,
                    n = r.globals.gridHeight, l = o / (r.globals.dataPoints - 1), h = n / r.globals.dataPoints,
                ...
                var f = Math.round(g / l), x = Math.floor(u / h);
        ...
        return a(t, [{
            ...
            key: "printLabels", value: function (t) {
                var e, i = this, a = t.i, s = t.j, r = t.values, n = t.ttItems, l = t.shared, h = t.e, c = this.w,
                    d = [], g = function (t) {
                        return c.globals.seriesGoals[t] && c.globals.seriesGoals[t][s] && Array.isArray(c.globals.seriesGoals[t][s])
                    }, u = r.xVal, p = r.zVal, f = r.xAxisTTVal, x = "", b = c.globals.colors[a];
                ...
                for (var m = function (t, r) {
                    ...
                    if (c.globals.axisCharts) {
                        ...
                        l ? (m = i.getFormatters(v), x = i.getSeriesName({
                            ...
                            return {attrs: t, val: m.yLbFormatter(t.value, {seriesIndex: v, dataPointIndex: s, w: c})}
                            ...
                            return {attrs: t, val: m.yLbFormatter(t.value, {seriesIndex: a, dataPointIndex: s, w: c})}
                        }))))
                    }
        ...
        return a(s, [{
            key: "draw", value: function (t, e) {
                ...
                for (var n = this.graphics.group({class: "apexcharts-bar-series apexcharts-plot-series"}), l = 0, h = 0, c = function (s, r) {
                    var c = void 0, d = void 0, g = void 0, u = void 0, f = [], x = [],
        ...
        return a(s, [{
            key: "draw", value: function (t, e) {
                ...
                for (var n = s.group({class: "apexcharts-".concat(a.config.chart.type, "-series apexcharts-plot-series")}), l = function (o) {
                    ...
                    var l, h, c = void 0, d = void 0, g = [], u = [], f = a.globals.comboCharts ? e[o] : o,
                        x = s.group({
                            class: "apexcharts-series",
                    ...
                    for (var y = s.group({class: "apexcharts-datalabels", "data:realIndex": f}), w = function (e) {
                        var s = i.barHelpers.getStrokeWidth(o, e, f), n = i.drawBoxPaths({
                            indexes: {i: o, j: e, realIndex: f},
                            x: c,
                            y: d,
                            xDivision: l,
                            barWidth: m,
            ...
            key: "drawBoxPaths", value: function (t) {
                var e = t.indexes, i = t.x;
                t.y;
                var a = t.xDivision, s = t.barWidth, r = t.zeroH, o = t.strokeWidth, n = this.w, l = new b(this.ctx),
                ...
                var f = this.yRatio[this.yaxisIndex], x = e.realIndex, m = this.getOHLCValue(x, c), v = r, y = r;
                m.o > m.c && (d = !1);
        ...
        return a(t, [{
            ...
            key: "determineColor", value: function (t, e, i) {
                ...
                var n = a.globals.colors[o], l = null, h = Math.min.apply(Math, g(a.globals.series[e])),
            ...
            key: "calculateDataLabels", value: function (t) {
                var e = t.text, i = t.x, a = t.y, s = t.i, r = t.j, o = t.colorProps, n = t.fontSize,
                    l = this.w.config.dataLabels, h = new b(this.ctx), c = new M(this.ctx), d = null;
                if (l.enabled) {
            ...
            key: "draw", value: function (t) {
                ...
                for (var h = n ? 0 : l.length - 1; n ? h < l.length : h >= 0; n ? h++ : h--) {
                    ...
                    for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, f = 0; f < l[h].length; f++) {
                        var m = this.helpers.getShadeColor(e.config.chart.type, h, f, this.negRange), v = m.color,
                            y = m.colorProps;
        ...
        return a(t, [{
            key: "draw", value: function (t) {
                ...
                var f = i.config.plotOptions.pie.customScale, x = i.globals.gridWidth / 2, m = i.globals.gridHeight / 2,
                    v = x - i.globals.gridWidth / 2 * f, y = m - i.globals.gridHeight / 2 * f;
                ...
                for (var d = 0; d < t.length; d++) {
                    ...
                    if (!this.initialAnim || i.globals.resized || i.globals.dataChanged ? this.animBeginArr.push(0) : (0 === (k = u / this.fullAngle * i.config.chart.animations.speed) && (k = 1), this.animDur = k + this.animDur, this.animBeginArr.push(this.animDur)), this.dynamicAnim && i.globals.dataChanged ? this.animatePaths(v, {
                        ...
                        if (0 !== u && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
                            ...
                            var T = i.globals.dataLabels.style.colors[d], M = s.group({class: "apexcharts-datalabels"}),
                                I = s.drawText({
                                    x: A,
                                    y: S,
                                    text: C,
            ...
            key: "getPiePath", value: function (t) {
                ...
                var l = Math.PI * (n - 90) / 180, h = e.centerX + s * Math.cos(o), c = e.centerY + s * Math.sin(o),
                    ...
                    f = p.polarToCartesian(e.centerX, e.centerY, e.donutSize, r), x = a > 180 ? 1 : 0,
        ...
        return a(t, [{
            key: "draw", value: function (t) {
                var e = this, i = this.w, a = new L(this.ctx), s = [], r = new M(this.ctx);
                t.length && (this.dataPointsLen = t[i.globals.maxValsInArrayIndex].length), this.disAngle = 2 * Math.PI / this.dataPointsLen;
                var n = i.globals.gridWidth / 2, l = i.globals.gridHeight / 2,
                    h = n + i.config.plotOptions.radar.offsetX, c = l + i.config.plotOptions.radar.offsetY,
                ...
                if (this.yaxisLabels = this.graphics.group({class: "apexcharts-yaxis"}), t.forEach((function (t, n) {
                    ...
                    u = e.graphics.group({class: "apexcharts-series-markers-wrap apexcharts-element-hidden"}), f = e.graphics.group({
                        class: "apexcharts-datalabels",
                        "data:realIndex": n
                    ...
                    for (var m = 0; m < c.linePathsTo.length; m++) {
                        ...
                        h.add(v);
                        var y = a.fillPath({seriesNumber: n}), w = e.graphics.renderPaths(o(o({}, d), {}, {
            ...
            key: "drawPolygons", value: function (t) {
                ...
                n.forEach((function (t, i) {
                    var a = p.getPolygonPos(t, e.dataPointsLen), s = "";
            ...
            key: "drawXAxisTexts", value: function () {
                ...
                return e.globals.labels.forEach((function (r, n) {
                    ...
                    if (s[n]) {
                        var c = t.getTextPos(s[n], t.size), d = l(r, {seriesIndex: -1, dataPointIndex: n, w: e});
        ...
        return a(s, [{
            ...
            key: "drawTracks", value: function (t) {
                var e = this.w, i = new b(this.ctx), a = i.group({class: "apexcharts-tracks"}), s = new x(this.ctx),
                    r = new L(this.ctx), o = this.getStrokeWidth(t);
                t.size = t.size - o / 2;
            ...
            key: "drawArcs", value: function (t) {
                ...
                for (var m = f ? t.series.length - 1 : 0; f ? m >= 0 : m < t.series.length; f ? m-- : m++) {
                    ...
                    var y = a.fillPath({seriesNumber: m, size: t.size, value: t.series[m]}), w = this.startAngle,
                        k = void 0, A = p.negToZero(t.series[m] > 100 ? 100 : t.series[m]) / 100,
            ...
            key: "drawHollowImage", value: function (t, e, i, a) {
                var s = this.w, r = new L(this.ctx), o = p.randomId(), n = s.config.plotOptions.radialBar.hollow.image;
        ...
        return a(t, [{
            ...
            key: "_handlePaths", value: function (t) {
                var e = t.type, i = t.realIndex, a = t.i, s = t.paths, r = this.w, n = new b(this.ctx),
                    l = new L(this.ctx);
                ...
                if ("area" === e) for (var p = l.fillPath({seriesNumber: i}), f = 0; f < s.areaPaths.length; f++) {
                ...
                if (r.config.stroke.show && !this.pointsChart) {
                    var m = null;
                    m = "line" === e ? l.fillPath({seriesNumber: i, i: a}) : r.globals.stroke.colors[i];
            ...
            key: "_handleMarkersAndLabels", value: function (t) {
                ...
                var i = t.i, a = t.j, s = t.realIndex, r = this.w, o = new M(this.ctx);
            ...
            key: "_createPaths", value: function (t) {
                var e = t.series, i = t.i, a = t.realIndex, s = t.j, r = t.x, o = t.y, n = t.pX, l = t.pY,
                    ...
                    f = new b(this.ctx), x = p.config.stroke.curve, m = this.areaBottomY;
    ...
    var Tt, Mt, It = function () {
        ...
        return a(t, [{
            ...
            key: "rotateToFitLabel", value: function (t, e, i, a, s, r) {
                var o = new b(this.ctx), n = o.getTextRects(e);
        ...
        return a(t, [{
            key: "calculateTimeScaleTicks", value: function (t, e) {
                ...
                var n = s.getTimeUnitsfromTimestamp(t, e, this.utc), l = a.globals.gridWidth / r, h = l / 24,
                    c = h / 60, d = c / 60, g = Math.floor(24 * r), u = Math.floor(1440 * r), p = Math.floor(r * zt),
                    f = Math.floor(r), x = Math.floor(r / 30), b = Math.floor(r / 365), m = {
                ...
                var y = this.timeScaleArray.map((function (t) {
                    ...
                    return "month" === t.unit ? o(o({}, e), {}, {
                        day: 1,
                        value: t.value + 1
                    }) : "day" === t.unit || "hour" === t.unit ? o(o({}, e), {}, {value: t.value}) : "minute" === t.unit ? o(o({}, e), {}, {
                        value: t.value,
                        minute: t.value
                    }) : "second" === t.unit ? o(o({}, e), {}, {value: t.value, minute: t.minute, second: t.second}) : t
                }));
            ...
            key: "generateYearScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonth, a = t.currentYear, s = t.daysWidthOnXAxis, r = t.numberOfYears,
                    o = e.minYear, n = 0, l = new Y(this.ctx), h = "year";
            ...
            key: "generateMonthScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonthDate, a = t.currentMonth, s = t.currentYear,
                    r = t.daysWidthOnXAxis, o = t.numberOfMonths, n = a, l = 0, h = new Y(this.ctx), c = "month", d = 0;
                if (e.minDate > 1) {
                    l = (h.determineDaysOfMonths(a + 1, e.minYear) - i + 1) * r, n = p.monthMod(a + 1);
                    var g = s + d, u = p.monthMod(n), f = n;
            ...
            key: "generateDayScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonth, a = t.currentYear, s = t.hoursWidthOnXAxis, r = t.numberOfDays,
                    o = new Y(this.ctx), n = "day", l = e.minDate + 1, h = l, c = function (t, e, i) {
                ...
                for (var f = d, x = 0; x < r; x++) {
                    ...
                    this.timeScaleArray.push({position: f, value: m, unit: n, year: b, month: p.monthMod(u), day: m})
                }
            }
        }, {
            key: "generateHourScale", value: function (t) {
                var e = t.firstVal, i = t.currentDate, a = t.currentMonth, s = t.currentYear, r = t.minutesWidthOnXAxis,
                    o = t.numberOfHours, n = new Y(this.ctx), l = "hour", h = function (t, e) {
            ...
            key: "setupBrushHandler", value: function () {
                ...
                if (e.config.chart.brush.enabled && "function" != typeof e.config.chart.events.selection) {
                    ...
                    i.forEach((function (e) {
                        ...
                        i.forEach((function (t) {
                            var i = ApexCharts.getChartByID(t), s = p.clone(e.config.yaxis);
        ...
        return a(i, [{
            ...
            key: "_updateSeries", value: function (t, e) {
                ...
                }))).length && (i = [{data: []}]), r.config.series = i) : r.config.series = t.slice(), s && (r.globals.initialSeries = p.clone(r.config.series)), this.ctx.update()
            }
        }, {
    ...
    Tt = "undefined" != typeof window ? window : void 0, Mt = function (e, i) {
        ...
        a.PathArray = function (t, e) {
            ...
            create: function (e, i) {
                ...
                if (Array.isArray(e)) for (var a = 0, s = this.arguments.length; a < s; ++a) this[this.arguments[a]] = e[a]; else if (e && "object" === t(e)) for (a = 0, s = this.arguments.length; a < s; ++a) this[this.arguments[a]] = e[this.arguments[a]];
                ...
                case"A":
                    t = (e = function (t, e) {
                        var i, a, s, r, o, n, l, h, c, d, g, u, p, f, x, b, m, v, y, w, k, A, S, C, L, P,
                            T = Math.abs(e[1]), M = Math.abs(e[2]), I = e[3] % 360, z = e[4], X = e[5], E = e[6],
    ...
    return function () {
        ...
        return a(t, [{
            ...
            key: "create", value: function (t, e) {
                ...
                var n = this.core.plotChartType(t, o), l = new M(this);
            ...
            key: "mount", value: function () {
                ...
                return new Promise((function (s, r) {
                    ...
                    var n = new G(t.ctx), l = new q(t.ctx);
            ...
            key: "getChartByID", value: function (t) {
                var e = p.escapeString(t), i = Apex._chartInstances.filter((function (t) {
                    return t.id === e
                }))[0];
                return i && i.chart
            }
